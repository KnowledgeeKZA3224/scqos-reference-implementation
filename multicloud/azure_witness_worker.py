...
permit=((observed.get("status")=="ONLINE" and observed.get("cloud")=="AWS" and observed.get("contract_id")==CONTRACT_ID and observed.get("contract_sha256")==CONTRACT_SHA) or (observed.get("state")=="PERMIT" and observed.get("service")=="SUPREME_APEX_V1" and observed.get("public_authority")=="READ_ONLY_AUTONOMY"))
